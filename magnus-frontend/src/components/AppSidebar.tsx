import { Calendar, DollarSign, Home, Settings, Bell, Moon, Sun, LogOut, User, CalendarDays, CheckSquare, TestTube } from 'lucide-react';
...
const navByRole = {
  admin: [
    ...
    { name: 'Test Panel', href: '/workflow-test', icon: TestTube },
  ],
  sales: [
    { name: 'Panel Principal', href: '/dashboard', icon: Home },
    { name: 'Crear Presupuestos', href: '/budgets', icon: Calendar },
    { name: 'Gestión de Clientes', href: '/clients', icon: User },
  ],
  logistics: [
    { name: 'Panel Principal', href: '/dashboard', icon: Home },
    { name: 'Planificación Semanal', href: '/weekly-planning', icon: CalendarDays },
    { name: 'Mis Tareas', href: '/tasks', icon: CheckSquare },
    { name: 'Eventos Activos', href: '/budgets', icon: Calendar },
  ],
  cook: [
    { name: 'Panel Principal', href: '/dashboard', icon: Home },
    { name: 'Mis Tareas de Cocina', href: '/tasks', icon: CheckSquare },
    { name: 'Eventos del Día', href: '/budgets', icon: Calendar },
  ],
};
