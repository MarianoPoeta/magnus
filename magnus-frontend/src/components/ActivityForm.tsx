...
interface ActivityFormProps {
  ...
  onSubmit?: (data: Omit<Activity, 'id' | 'createdAt' | 'updatedAt'>) => Promise<void> | void;
}

const ActivityForm = ({ isOpen, onClose, activity, onSubmit }: ActivityFormProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Keep dialog open on error; error can be surfaced by parent via toast
