  ...
  if (!currentUser) {
    return (
      <div className="flex items-center justify-center min-h-[50vh]">
        <span className="text-slate-600">Cargando perfil...</span>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-lg mx-auto py-12">
      <div className="flex flex-col items-center mb-8">
        ...
        <span className="text-xs text-slate-500">{currentUser?.role ? currentUser.role.charAt(0).toUpperCase() + currentUser.role.slice(1) : ''}</span>
      </div>
