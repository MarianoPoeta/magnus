...
import com.magnus.repository.ClientRepository;
import com.magnus.service.dto.ClientDTO;
import com.magnus.service.mapper.ClientMapper;
...
class ClientResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "c@~>,|.\"Zpy";
    private static final String UPDATED_EMAIL = "'HZwAr@q./bCc4";
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.email(UPDATED_EMAIL).company(UPDATED_COMPANY).taxId(UPDATED_TAX_ID).isActive(UPDATED_IS_ACTIVE);
